...
function Footer() {
  return (
    <div className='py-5 md:px-20 px-10 bg-violet-900 md:grid grid-cols-[repeat(1,2fr)_repeat(2,1fr)_repeat(1,2fr)] text-white'>
 <div>
  <h2 className='text-4xl'><FontAwesomeIcon icon={faCartShopping} /> E-CART</h2>
  <p className='mt-5 text-justify'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Libero, necessitatibus temporibus veritatis cum totam corrupti nam voluptates fugiat velit voluptatem cumque quae odit beatae officia repudiandae modi. Ut, fuga doloribus.</p>
 </div>
